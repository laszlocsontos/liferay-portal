...
public class PortalImplSiteLocaleTest {
	...
	@Test
	public void testSiteUnavailableLanguageId() throws Exception {
		testLocaleForLanguageId("/pt", LocaleUtil.GERMANY);
	}

	@Test
	public void testSiteUnavailableLocale() throws Exception {
		testLocaleForLanguageId("en_US", LocaleUtil.GERMANY);
	}
	...
	protected void testLocaleForLanguageId(
		...
		MockHttpServletRequest httpServletRequest = createHttpRequest(
			mockServletContext, i18nLanguageId, getPath(_group, _layout));
