...
public class PropsValues {
	...
	public static boolean LAYOUT_PROTOTYPE_LAR_SKIP_EXISTING_PERMISSION_CHECK = GetterUtil.getBoolean(PropsUtil.get(PropsKeys.LAYOUT_PROTOTYPE_LAR_SKIP_EXISTING_PERMISSION_CHECK));
