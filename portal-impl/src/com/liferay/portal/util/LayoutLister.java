...
public class LayoutLister {
	...
	public LayoutView getLayoutView(
		...
		Map<Long, Deque<Layout>> layoutsBag = _getLayoutsBag(layouts);

		_createList(layoutsBag);

		return new LayoutView(_list, _depth);
	}

	private void _createList(Map<Long, Deque<Layout>> layoutsBag) {
	...
	private Map<Long, Deque<Layout>> _getLayoutsBag(List<Layout> layouts) {
	...
	private void _visitLayout(LayoutNode layoutNode) {
