...
public class AssetCategoryLocalServiceImpl
	...
	@Override
	public BaseModelSearchResult<AssetCategory> searchAssetCategories(
			long companyId, long groupIds, String title, long vocabularyId,
			int start, int end)
		throws PortalException, SystemException {

		return searchAssetCategories(
	...
	public BaseModelSearchResult<AssetCategory> searchAssetCategories(
		...
		return searchAssetCategories(searchContext);
	}
	...
	protected BaseModelSearchResult<AssetCategory> searchAssetCategories(
