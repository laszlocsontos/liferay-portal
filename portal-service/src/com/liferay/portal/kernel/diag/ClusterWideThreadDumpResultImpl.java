...
public class ClusterWideThreadDumpResultImpl implements ThreadDumpResult {

	public ClusterWideThreadDumpResultImpl(int clusterNodeAddressCount) {
	...
	private static Log _log = LogFactoryUtil.getLog(
		ClusterWideThreadDumpResultImpl.class);
