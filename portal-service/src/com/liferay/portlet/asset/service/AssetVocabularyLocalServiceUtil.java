...
public class AssetVocabularyLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.portal.kernel.search.BaseModelSearchResult<com.liferay.portlet.asset.model.AssetVocabulary> searchAssetVocabularies(
		long groupId, java.lang.String title, int start, int end)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().searchAssetVocabularies(groupId, title, start, end);
	}
